<script lang="jsx">
  ...
  import BaseRadio from '../radio/radio';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="base-icon-check base-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="base-icon-loading base-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="base-icon-arrow-right base-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="base-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
