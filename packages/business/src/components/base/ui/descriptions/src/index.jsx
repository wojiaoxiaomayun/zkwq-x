  ...
  methods: {
    ...
    getRows() {
      const children = ((this.$slots.default || []).filter(vnode => vnode.tag &&
            vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'BaseDescriptionsItem'));
      ...
      <div class="base-descriptions">
        {
          (title || extra || $slots.title || $slots.extra)
            ? <div class="base-descriptions__header">
              <div class="base-descriptions__title">
                { $slots.title ? $slots.title : title}
              </div>
              <div class="base-descriptions__extra">
        ...
        <div class="base-descriptions__body">
          <table class={['base-descriptions__table', {'is-bordered': border}, descriptionsSize ? `base-descriptions--${descriptionsSize}` : '']}>
            {rows.map(row => (
