<template>
  <transition name="base-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="base-time-panel base-popper"
      :class="popperClass">
      <div class="base-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
      ...
      <div class="base-time-panel__footer">
        ...
        <button
          type="button"
          class="base-time-panel__btn"
          :class="{confirm: !disabled}"
          @click="handleConfirm()">{{ t('base.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from '../../util/date-util';
