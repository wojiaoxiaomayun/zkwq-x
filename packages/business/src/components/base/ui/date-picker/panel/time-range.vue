<template>
  <transition
    ...
    <div
      v-show="visible"
      class="base-time-range-picker base-picker-panel base-popper"
      :class="popperClass">
      <div class="base-time-range-picker__content">
        <div class="base-time-range-picker__cell">
          <div class="base-time-range-picker__header">{{ t('base.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="base-time-range-picker__body base-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="base-time-range-picker__cell">
          <div class="base-time-range-picker__header">{{ t('base.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="base-time-range-picker__body base-time-panel__content">
            <time-spinner
      ...
      <div class="base-time-panel__footer">
        <button
          type="button"
          class="base-time-panel__btn cancel"
          @click="handleCancel()">{{ t('base.datepicker.cancel') }}</button>
        <button
          type="button"
          class="base-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled">{{ t('base.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
