  ...
  <div
    ...
    <span
      ...
      <i
        ...
        class="base-rate__icon"
        :style="getIconStyle(item)">
        <i
          v-if="showDecimalIcon(item)"
          :class="decimalIconClass"
          :style="decimalStyle"
          class="base-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="base-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['base-icon-star-on', 'base-icon-star-on', 'base-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'base-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'base-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'base-rate__item')) {
            target = target.querySelector('.base-rate__icon');
          }
          if (hasClass(target, 'base-rate__decimal')) {
