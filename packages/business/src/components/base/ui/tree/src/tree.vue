<template>
  <div
    class="base-tree"
    :class="{
      'base-tree--highlight-current': highlightCurrent,
  ...
  >
    ...
    <div class="base-tree__empty-block" v-if="isEmpty">
      <span class="base-tree__empty-text">{{ emptyText }}</span>
    </div>
    <div
      v-show="dragState.showDropIndicator"
      class="base-tree__drop-indicator"
      ref="dropIndicator">
    </div>
  </div>
</template>
...
<script>
  ...
  import BaseTreeNode from './tree-node.vue';
  ...
  export default {
    ...
    created() {
      ...
      this.$on('tree-node-drag-over', (event, treeNode) => {
        ...
        const iconPosition = dropNode.$el.querySelector('.base-tree-node__expand-icon').getBoundingClientRect();
