  ...
  <div class="Readable__wrap">
    ...
    <div class="ContentItem" :class="{'is-en':!isChineseReadable}">
      ...
      <h2 class="ContentItem__title" @click="goToDetail">
        ...
        <span v-if="showPdfIcon && (!isArrayEmpty(readable.local_links) || readable.download_url || (!isArrayEmpty(readable.attachments) && readable.attachments.filter(e => e.file_name.endsWith('.pdf')).length))" class="ContentItem__pdf">
        ...
        <span class="ContentItem__linkDotMeta" v-if="showOpenAccesss && readable.type === TYPE_ARTICLE && (readable.is_free || !isArrayEmpty(readable.local_links))">
          <span class="ContentItem__linkDot"></span>
          <span>Open access</span>
        </span>
